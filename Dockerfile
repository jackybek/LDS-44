...
RUN cmake -S .. -DCMAKE_C_COMPILER=/usr/local/gcc14.2.0/bin/gcc14.2.0 -DCMAKE_C_COMPILER_AR=/usr/local/gcc14.2.0/bin/gcc-ar14.2.0 \
...
RUN export SSLCERTIFICATELOC="/usr/local/ssl/certs/ldscert44.pem"
