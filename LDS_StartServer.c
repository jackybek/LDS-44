...
void* StartOPCUALDSServer(void* x_void_ptr, char* argv)
{
	...
	if (g_argc==2) 	// myNewLDSServer 192.168.1.44 //192.168.1.88 [192.168.1.11]
	{
		...
		*/
		...
		UA_LOG_INFO(UA_Log_Stdout, UA_LOGCATEGORY_USERLAND,"LDS_StartServer.c : Successfully loaded LDS Certficate");
		...
		UA_LOG_INFO(UA_Log_Stdout, UA_LOGCATEGORY_USERLAND,"LDS_StartOPCUAServer.c : Successfully loaded LDS privateKey");
